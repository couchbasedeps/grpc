...
std::vector<CoreTestConfiguration> End2endTestConfigs() {
  ...
  if (IsExperimentEnabled(
    ...
    list_of_configs = std::vector<CoreTestConfiguration>{
        ...
        CoreTestConfiguration{
            ...
            /*feature_mask=*/FEATURE_MASK_SUPPORTS_CLIENT_CHANNEL |
                ...
                FEATURE_MASK_IS_HTTP2 | FEATURE_MASK_IS_LOCAL_TCP_CREDS |
        ...
        CoreTestConfiguration{
            ...
            /*feature_mask=*/FEATURE_MASK_IS_SECURE | FEATURE_MASK_IS_HTTP2 |
                FEATURE_MASK_SUPPORTS_PER_CALL_CREDENTIALS |
                FEATURE_MASK_SUPPORTS_CLIENT_CHANNEL |
                FEATURE_MASK_DOES_NOT_SUPPORT_CLIENT_HANDSHAKE_COMPLETE_FIRST |
                FEATURE_MASK_IS_CALL_V3 | FEATURE_MASK_IS_PH2_CLIENT |
        ...
        CoreTestConfiguration{
            ...
            /*feature_mask=*/kH2TLSFeatureMask | FEATURE_MASK_IS_CALL_V3 |
                FEATURE_MASK_IS_PH2_CLIENT | FEATURE_MASK_DO_NOT_FUZZ,
            "foo.test.google.fr",
            [](const ChannelArgs&, const ChannelArgs&) {
