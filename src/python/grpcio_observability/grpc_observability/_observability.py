...
class StatsData:
    ...
    Attributes:
      ...
      identifiers: A set of strings identifying which stats plugins this StatsData
        belongs to.
      registered_method: Whether the method in this data is a registered method in
        stubs.
    """
...
class TracingData:
    ...
    Attributes:
      ...
      trace_id: The identifier for the trace associated with this span as a
        32-character hexadecimal encoded string, e.g.
        26ed0036f2eff2b7317bccce3e28d01f
      ...
      span_labels: A dictionary that maps labels tags associated with this span to
        corresponding label value.
      span_annotations: A dictionary that maps annotation timeStamp with
        description. The timeStamp have a format which can be converted to Python
